(function(){
	...
	app.controller('preOrder', function(){
		...
		this.preOrderForm = function() {
			...
			var CustomerOrder = new Firebase('https://shop-data.firebaseio.com/Customers%20order');
			...
			Order.splice(0, 0,
				"заказчик: " + document.getElementById("order_name").value
				+ ", " +
				document.getElementById("order_cellphone").value
				+ " / " +
				sessionStorage.getItem("total") + "грн."
			);
